...
// This method free clears up the screen, and free all the memory allocated to the 
// saved shapes. It gets pShape pointer to reset the current shape, pHead & temp pointers
// to free up the memory of the currently saved shapes, and a window to clear.
